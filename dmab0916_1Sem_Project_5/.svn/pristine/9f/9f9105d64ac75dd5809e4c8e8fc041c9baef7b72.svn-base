...
public class Setup {
	...
	public static void setup(){
		...
		p1 = new Product(1500, 2000, "10384", "snescooter", "vinter", "Hylde 1", 10, 4, 15, s3);
		p2 = new Product(800, 1000, "102732", "kælk", "vinter", "hylde4", 5, 20, 30, s3);
		p3 = new Product(1000, 1200, "100233", "hurtig kælk", "vinter", "hylde 5", 3, 4, 25, s1);
		p4 = new Product(100, 300, "1024", "kaffemaskine", "hvidevarer", "hylde 17", 5, 6, 10, s2);
		p5 = new Product(1300, 1500, "15", "vaskemaskine", "hårdeHvidevarer", "hylde 19", 4, 4, 5, s1);
		...
		c4 = new Customer("Polle Hansen", "Birkevej 67", "polle@gmail.com", "15436789", "privat");
