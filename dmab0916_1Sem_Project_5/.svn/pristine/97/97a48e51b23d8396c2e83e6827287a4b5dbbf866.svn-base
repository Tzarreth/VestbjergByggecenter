...
public class StockView extends JFrame {
	...
	public StockView() {
		...
		txtQuery.setBounds(40, 13, 254, 22);
		...
		btnClose.setBounds(Constants.btnBackXCoordinate, Constants.btnBackYCoordinate, Constants.btnBackWidth, Constants.btnBackHeight);
